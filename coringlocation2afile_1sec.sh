...
# the corrected coring location position to assign nav for piston cores, box
# cores, IKU and VanVeen grabs.
#
...
INPUT=$1
OUTPUT="coringlocation_nav_1sec.txt"

echo -e "\nExtracting coring location nav; please standby...\n"

awk -F'|' '/Coring Location/ {print $5, $6}' ${INPUT} | sed 's/[TZ]/ /g' \
...
-e 's/^2018-09-07/250/' -e 's/^2018-09-08/251/' -e 's/^2018-09-09/252/' > ${OUTPUT}
