...
INPUT=$1
OUTPUT="CRPlocation_nav_1sec.txt"
...
-e 's/^2018-08-22/234/' -e 's/^2018-08-23/235/' -e 's/^2018-08-24/236/' \
-e 's/^2018-08-25/237/' -e 's/^2018-08-26/238/' -e 's/^2018-08-27/239/' -e 's/^2018-08-28/240/' \
...
-e 's/^2018-09-07/250/' -e 's/^2018-09-08/251/' > ${OUTPUT}
