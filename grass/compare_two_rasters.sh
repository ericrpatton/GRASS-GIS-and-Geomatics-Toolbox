...
############################################################################
#
# MODULE:        compare_two_rasters.sh
#
# AUTHOR:   	 Eric Patton, Geological Survey of Canada (Atlantic)
#		 		 <eric dot patton at canada dot ca>
# 
# PURPOSE:       To export a pair of raster maps from GRASS GIS and create a
# one-page GMT plot of each map as indivdual figures, with accompanying
# graticules and color bars.
#		 		 
