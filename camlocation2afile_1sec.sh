...
# the corrected Towcam deployment position and write to a nav file.
...
INPUT=$1
OUTPUT="camlocation_nav_1sec.txt"

echo -e "\nExtracting camera location nav; please standby...\n"

awk -F'|' '/Camera Location/ {print $5, $6}' ${INPUT} | sed 's/[TZ]/ /g' \
